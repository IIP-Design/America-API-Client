...
const Quiz = React.createClass({
  ...
  checkAnswers () {
	...
	render () {
        ...
        <input type="button" value="Check Answers" onClick={ this.checkAnswers } />
      </div>
		);
	}
});

//  <input type="button" disabled={ this.props.allAnswered ? false: true }  value="Check Answers" onClick={ this.checkAnswers } /> // testing
