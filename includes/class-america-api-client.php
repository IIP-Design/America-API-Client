...
class America_API_Client {
   ...
   */
	 ...
	 *
	 * - America_API_Client_Loader. Orchestrates the hooks of the plugin.
	 * - America_API_Client_i18n. Defines internationalization functionality.
	 * - America_API_Client_Admin. Defines all hooks for the admin area.
	 * - America_API_Client_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-america-api-client-loader.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-america-api-client-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-america-api-client-admin.php';
		...
		$this->loader = new America_API_Client_Loader();
	}
	 ...
	 *
	 * Uses the America_API_Client_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    America_API_Client_Loader    Orchestrates the hooks of the plugin.
	 */
